...
- C2: recibe como parámetros el título y el artista y crea una canción con duración de 0 segundos y el resto de atributos nulos.
...
- Double getDistancia(Coordenadas c): Devuelve la distancia euclídea entre la coordenada con la que se invoca al método y la coordenada c.
- Double getDistanciaHarversine(Coordenadas c): Devuelve la distancia de Harversine entre la coordenada con la que se invoca al método y la coordenada c.
